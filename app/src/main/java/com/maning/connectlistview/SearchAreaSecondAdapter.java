 ...
 */
public class SearchAreaSecondAdapter extends BaseAdapter {
    ...
    public SearchAreaSecondAdapter(Context mContext, List<String> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mPosition == position) {
            viewHolder.textView.setBackgroundColor(mContext.getResources().getColor(R.color.colorThirdItemBackground));
